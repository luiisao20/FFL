<template>
    ...
    <section id="main">
        ...
        <h1 class="title text-[#ffbc00] mt-[150px] text-center text-6xl">CLASIFICACIÓN GLOBAL</h1>
        <table class="text-white text-2xl mx-auto w-[70%] text-center">
            ...
            <tbody>
                <tr v-for="(item, index) in items">
                    ...
                    <td class="border border-white p-2 flex flex-row items-center justify-between pl-10 pr-10">
                        {{ item[1] }}
                        <div class="h-[50px]">
                            <img :src="`./src/components/participants/${item[1].toLocaleLowerCase()}.png`" alt="" class="h-full">
                        </div>
                    </td>
